...
## Set up server to server Front End File

1. Clone Project

```
https://github.com/cfunkles/Sam-Brittany-Wedding.git
```
...
- In web browser go to http://(Host Ip Address):8080/stream.html
